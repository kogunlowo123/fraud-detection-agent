"""Fraud Detection Agent - Domain-Specific Connectors."""
...
class NetsuiteConnector:
    """Domain-specific connector for netsuite integration with Fraud Detection Agent."""
...
class QuickbooksConnector:
    """Domain-specific connector for quickbooks integration with Fraud Detection Agent."""
...
class XeroConnector:
    """Domain-specific connector for xero integration with Fraud Detection Agent."""
...
class SapConnector:
    """Domain-specific connector for sap integration with Fraud Detection Agent."""
...
class OracleFinancialsConnector:
    """Domain-specific connector for oracle financials integration with Fraud Detection Agent."""
