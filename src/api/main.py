"""Fraud Detection Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Financial fraud detection agent that analyzes transactions for anomalies, calculates risk scores, flags suspicious patterns, manages investigation workflows, and generates SAR reports.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
