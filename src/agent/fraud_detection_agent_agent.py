"""Fraud Detection Agent - Main Agent Implementation."""
...
class FraudDetectionAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.fraud_enabled = True
        self.detection_enabled = True
        self.compliance_enabled = True
        self.reporting_enabled = True
        self._tool_dispatch = {
            "analyze_transaction": self.tools.analyze_transaction,
            "calculate_risk_score": self.tools.calculate_risk_score,
            "flag_anomaly": self.tools.flag_anomaly,
            "manage_investigation": self.tools.manage_investigation,
            "generate_sar": self.tools.generate_sar,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['fraud', 'detection', 'compliance', 'reporting'],
        )
