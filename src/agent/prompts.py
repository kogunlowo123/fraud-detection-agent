"""Fraud Detection Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Fraud Detection Agent, an enterprise finance automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Fraud Detection Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Fraud Detection Agent:
